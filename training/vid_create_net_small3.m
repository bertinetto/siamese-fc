...
% --------------------------------------------------------------------
    ...
    %% /2 until conv2, then /8 conv3-5
    net = add_block(net, opts, '3', 3, 3, 128, 48, 1, 0) ;
    net = add_block(net, opts, '4', 3, 3, 48, 48, 1, 0) ;
    net = add_block_conv_only(net, opts, '5', 3, 3, 48, 32, 1, 0) ;
